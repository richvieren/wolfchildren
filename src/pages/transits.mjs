...
const page = readingPage({
  ...
  inside: [
    ...
    { title: 'What does not change this year', line: 'The chart your child was born with, under all of it, so the year reads as weather over a landscape.' },
  ...
  includes: [
    'The report: eighteen to twenty-six pages, written for your child’s next twelve months',
