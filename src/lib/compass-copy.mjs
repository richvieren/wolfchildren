...
//
// Richard approved this on 2026-09-24 and held the hero subtext at its full length against the
// design skills that cap it. Every variant renders these exact words; only the design differs.
// Nothing here may be reworded to suit a layout. If a skill cannot fit the copy, the variant says so.
